      ...
      <li><a href="HOME.htm">LOGOUT</a></li>
        ...
        <c:forEach items="${ProductLists}" var="product">
            <tr>
                ...
                <td>
                    <a href="addevidence.htm?eid=${product.id}" style="display: inline-block; margin-right: 10px; padding: 8px 16px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">ADD EVIDENCE</a>    
